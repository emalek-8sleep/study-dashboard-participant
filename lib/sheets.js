...
// Lightweight in-process cache for Study Config — avoids duplicate fetches
// within a single cold-start invocation. Keyed by sheetId.
...
export async function getStudyConfig(sheetId) {
  ...
  // Return cached result if we already fetched this config in the same invocation
